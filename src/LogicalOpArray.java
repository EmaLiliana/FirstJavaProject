public class LogicalOpArray {
    ...
    public void getEvenNumbersFromArray(int [] arrayEvenPosition) {
        arrayEvenPosition = new int[100];
        for (int i = 0; i < 100; i++) {
           arrayEvenPosition[i] = i + 1;
        }
        for (int i = 0; i<100; i++){

            if (arrayEvenPosition[i] % 2 == 0) {
                System.out.print(arrayEvenPosition[i] + " ");
    ...
    //Creati o metoda care sa insereze un element pe o pozitie specifica intr-un array.
